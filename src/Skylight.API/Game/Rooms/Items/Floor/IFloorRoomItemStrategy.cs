...
{
	public IFloorRoomItem CreateFloorItem(int itemId, IPrivateRoom room, IUserInfo owner, IFloorFurniture furniture, Point3D position, int direction, JsonDocument? extraData = null)
