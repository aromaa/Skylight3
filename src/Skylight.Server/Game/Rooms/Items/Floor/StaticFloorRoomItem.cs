...
internal sealed class StaticFloorRoomItem(IPrivateRoom room, RoomItemId id, IUserInfo owner, IStaticFloorFurniture furniture, Point3D position, int direction)
