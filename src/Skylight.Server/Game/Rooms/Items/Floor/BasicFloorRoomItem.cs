...
internal sealed class BasicFloorRoomItem(IPrivateRoom room, int id, IUserInfo owner, IBasicFloorFurniture furniture, Point3D position, int direction, int state)
