...
internal sealed class VariableHeightRoomItem(IPrivateRoom room, RoomItemId id, IUserInfo owner, IVariableHeightFurniture furniture, Point3D position, int direction, int state)
