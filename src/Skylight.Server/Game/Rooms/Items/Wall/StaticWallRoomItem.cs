...
internal sealed class StaticWallRoomItem(IPrivateRoom room, int id, IUserInfo owner, IStaticWallFurniture furniture, Point2D location, Point2D position, int direction)
