...
public interface IFurnitureItemDataBuilder<in TFurniture, in TItemId, out TTarget, out TBuilder, out TFurnitureBuilder> : IFurnitureItemDataBuilder<TFurniture, TTarget, TBuilder>
	where TFurniture : IFurniture
	where TTarget : IFurnitureItem<TFurniture>
	where TBuilder : IFurnitureItemDataBuilder<TFurniture, TItemId, TTarget, TBuilder, TFurnitureBuilder>
	where TFurnitureBuilder : IFurnitureItemBuilder<TFurniture, TItemId, TTarget, TFurnitureBuilder, TBuilder>
{
